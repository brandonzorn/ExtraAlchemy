...
public class RecallStatusEffect extends ModStatusEffect {
    ...
    public void applyUpdateEffect(LivingEntity entity, int i) {
        if (!entity.getEntityWorld().isClient) {
            // Since the teleport method might clone the entity, this holds the most recent instance of the entity
            LivingEntity ent = entity;
            ...
            try {
                ...
                assert EntityProperties.of(ent) != null;
                EntityProperties.of(ent).setRecallData(null);
            }
        }
    }
